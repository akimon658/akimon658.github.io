...
<comp.Card href="https://github.com/juju/persistent-cookiejar" title="juju/persistent-cookiejar: cookiejar is a fork of net/http/cookiejar that allows serialisation of the stored cookies" />
